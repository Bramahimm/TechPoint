...
const KATEGORI_LIST = ["semua", "Laptop", "Smartphone", "Kamera", "Aksesoris"] as const;
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {products.map((product) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 w-full bg-blue-500 text-white text-center text-sm font-bold p-2 
